...
<div class="container py-5 h-100">
    ...
    <div class="col-md-12 col-xl-4">
        ...
        <div class="card-body text-center" style="border-radius: 15px; border: solid 0px #ffffff;">
            ...
            data-bs-target=".update-profile" style="color: #1A1A1A ;text-decoration: none;"><p class="text-muted mb-4" > Edit profile <i class='far fa-edit'></i> </p></a>


            

            <div class="mb-4 pb-2" >
            <a type="button" href="{{route('order')}}"  class="btn btn-rounded btn-lg" style="margin:5px; --bs-btn-padding-x: 59px; background-color:#1A1A1A ; color:#ffffff  ">
                My orders 
            </a>
            </div>
            ...
            <div class="px-3">
                <p class="mb-2 h5">{{$user->order ? $user->order->count() : '0'}}</p>
