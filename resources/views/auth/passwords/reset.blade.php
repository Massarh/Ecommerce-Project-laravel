                                ...
                                <div class="mt-4">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <!-- Password -->
                                            <div
                                                class=" mb-3 input-group auth-pass-inputgroup @error('password-confirm') is-invalid @enderror">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="/"><i class="fa-solid fa-house"
                                                style="font-size: 25px ;color:#1a1a1a;"></i></a>
                                        <div><a href="/" style="color: #1a1a1a;font-size:11px ; ">Explore Home page</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
