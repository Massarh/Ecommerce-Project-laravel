...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Admins And Employees Tables</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"">Home</a></li>
            <li class=" breadcrumb-item">Admins/Employees</li>
            <li class="breadcrumb-item active" aria-current="page">Admins/Employees Tables</li>
        </ol>
    </div>
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold " style="color: #344f63">All {{$adminsAndEmployees[0]->category->name}} Admins And Employees</h6>
                </div>
