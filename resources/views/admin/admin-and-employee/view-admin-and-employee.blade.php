                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $adminOrEmployee->phone_number }}</td>
                                <td>{{ $adminOrEmployee->address }}</td>
                                <td>{{ $adminOrEmployee->user_role }}</td>
                                <td>
                                    <a href=" {{route('section.getSubcategoryByCatId',[ $adminOrEmployee->id])}} ">
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="exampleModal{{$adminOrEmployee->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form action=" {{ route('delete.admin', [$adminOrEmployee->id]) }} "
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
