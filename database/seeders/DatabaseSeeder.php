...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            'name'        => 'FLAT CRISS-CROSS [P, W, SHOES]',
            'image'       => 'public/product/FLAT CRISS-CROSS LEATHER SLIDER SANDALS.jpg',
            'price'       => 40.90,
            'description' => 'FLAT CRISS-CROSS LEATHER ',
            'additional_info' => 'SLIDER SANDALS',
            'store_id'    => 3,
            'category_id' => 9,
            'section'     => 'WOMEN'
        ]);
